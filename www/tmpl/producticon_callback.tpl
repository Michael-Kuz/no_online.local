		...
		<?php } ?>
			<td>
				<div class="intro_product">
					<?php 	
						$alias = SefDB::getAliasOnLink("/$link_desc?section_id=$product->section_id&id=$product->id");
						if( !$alias )
							$alias = URL::get("$link_desc","",array("section_id"=>$product->section_id, "id"=>$product->id));
						else
							$alias .= Config::SEF_SUFFIX;
					?>
